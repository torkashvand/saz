...
class TestErrorCategorization:
    ...
    def test_categorize_missing_credential(self):
    ...
    def test_categorize_http_error_500(self):
...
class TestRemediationActions:
    ...
    def test_missing_credential_actions(self):
    ...
    def test_http_error_actions(self):
...
class TestErrorMessageGeneration:
    """Test human-readable error message generation."""

    def test_generate_missing_credential_message(self):
    ...
    def test_generate_http_error_message(self):
...
class TestExtractors:
    ...
    def test_extract_http_status(self):
    ...
    def test_extract_credential_name_none(self):
    ...
    def test_extract_http_status_none(self):
