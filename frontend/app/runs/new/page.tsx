    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground mt-1">Fill in the form to execute the workflow</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {registeredFlow.workflow_summary.steps_count} steps •{' '}
              {registeredFlow.workflow_summary.ai_steps} AI operations
            </CardDescription>
          </CardHeader>
          <CardContent>
